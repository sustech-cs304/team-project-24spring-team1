  ...
  <div>
    ...
    <div class="row">
      <div class="col-lg-4" :class="{ 'text-right': isRTL }">
        <card type="chart">
          <template slot="header">
            <!-- <h5 class="card-category">{{ $t("dashboard.title") }}</h5> -->
            <h3 class="card-title">
              <i class="tim-icons icon-bell-55 text-primary"></i> Title
            </h3>
          </template>
          <div class="chart-area">
            <div class="custom-text">  Time: 14:00-16:00</div>
            <div class="custom-text">  Place: Lecture Hall</div>
